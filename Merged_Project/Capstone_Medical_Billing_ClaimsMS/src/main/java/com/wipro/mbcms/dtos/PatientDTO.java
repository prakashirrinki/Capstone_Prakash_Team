...
public class PatientDTO {
	...
	public PatientDTO(long patientId, String patientFullName, String patientEmail, String gender, Date dateOfBirth,
	...
	public String toString() {
		return "PatientDTO [patientId=" + patientId + ", patientFullName=" + patientFullName + ", patientEmail="
